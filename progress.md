...
- [ ] 20章 非同期プログラミング
    ...
    - [x] 20.3 原始的なフューチャとエグゼキュータ : フューチャを再度ポーリングするべきなのはいつか？
        - [x] 20.3.1 ウェイカの起動 : spawn_bloking
        - [x] 20.3.2 block_onの実装
    - [x] 20.4 ピン留め
        - [x] 20.4.1 フューチャの2つのライフステージ
        - [x] 20.4.2 ピン留めされたポインタ
        - [x] 20.4.3 Unpinトレイト
    - [x] 20.5 非同期コードはどのような場合に使うべきか？
